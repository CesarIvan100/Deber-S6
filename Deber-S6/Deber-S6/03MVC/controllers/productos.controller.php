...
switch ($_GET["op"]) {
    ...
    case 'insertar':
        $nombre = $_POST['nombre'];
        $precio = $_POST['precio'];
        $id = $producto->insertProducto($nombre, $precio);
        echo $id ? "Producto insertado con ID: $id" : "Error al insertar producto";
        break;
    ...
    case 'actualizar':
        ...
        $nombre = $_POST['nombre'];
        $precio = $_POST['precio'];
        $result = $producto->updateProducto($id, $nombre, $precio);
